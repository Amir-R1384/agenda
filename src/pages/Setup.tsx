		...
		<>
			...
			<main
				...
				<section className="flex flex-col items-center text-center">
					...
					<div className="mb-10 text-dark-2 text-para">{t('scheduleDesc')}</div>
				...
				<section className="flex flex-col items-center text-center">
					...
					<div className="mb-20 text-dark-2 text-para">{t('homeworksDesc')}</div>
				...
				<section className="flex flex-col items-center text-center gap-y-5">
					<div className="font-extrabold text-heading text-dark-1">{t('notIt')}</div>
					<div className="max-w-4xl mb-5 text-dark-2 text-para">{t('otherFeatures')}</div>
