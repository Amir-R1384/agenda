import { Bars3Outline, XMarkOutline } from '@graywolfai/react-heroicons'
...
export default function Header() {
	...
	return (
		<header
			...
			<DayInfo />
			<button className="transition-all" onClick={() => setSettingsOpen(prev => !prev)}>
				{settingsOpen ? (
					<XMarkOutline className="icon" />
				) : (
