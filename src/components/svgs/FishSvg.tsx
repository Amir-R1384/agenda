export default function FishSvg({ className = '' }: { className?: string }) {
	return (
		<svg
			...
			<path d="M21.8 7.70001C18.6 8.50001 16 9.60001 16 10C16 11.6 19 13.2 20.7 12.5C21.7 12.1 25.4 11.5 29 11.1L35.5 10.5L33.3 8.20001C30.7 5.70001 29.7 5.60001 21.8 7.70001Z" />
			...
			<path d="M24 40C24 42.7 28.9 42.7 32.1 40L34.5 38.1L29.3 38C24.7 38 24 38.2 24 40Z" />
		</svg>
	)
}
